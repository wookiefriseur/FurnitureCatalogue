...
function FurC.CreateSettings(savedVars, defaults)
  ...
  local optionsData = { -- optionsData
    ...
    { -- checkbox: Enable
      ...
      getFunc = function()
        return (FurC.GetEnableShoppingList())
      end,
      setFunc = function(value)
        FurC.SetEnableShoppingList(value)
      end,
    },
    ...
    { -- checkbox: Skip Initial Scan
      ...
      getFunc = function()
        return FurC.GetSkipInitialScan()
      end,
      setFunc = function(value)
        FurC.SetSkipInitialScan(value)
      end,
    },
    -- =======================================================================================
    ...
    { -- header: Inventory and bank
      ...
      controls = {
        ...
        { -- checkbox: Only mark unknown recipes
          ...
          getFunc = function()
            return FurC.GetHideKnownInventoryIcons()
          end,
          setFunc = function(value)
    ...
    { -- slider: font size
      ...
      max = 28,
      getFunc = function()
        return FurC.GetFontSize()
      end,
      setFunc = function(value)
        FurC.SetFontSize(value)
      end,
    },
    { -- checkbox: show inventory context menu?
      ...
      getFunc = function()
        return FurC.GetHideInventoryMenu()
      end,
      setFunc = function(value)
    ...
    },
    {
      ...
      controls = {
        ...
        { -- checkbox: Persistent?
          ...
          getFunc = function()
            return FurC.GetResetDropdownChoice()
          end,
          setFunc = function(value)
            FurC.SetResetDropdownChoice(value)
          end,
        },
        ...
        { -- dropdown: default version
          ...
          setFunc = function(value)
            FurC.SetDefaultDropdownChoice("Version", value)
          end,
        },
      },
    },
      ...
      controls = {
        {
          ...
          controls = {
            ...
            { -- checkbox: Filter everything when text searching without dropdown
              ...
              getFunc = function()
                return FurC.GetFilterAllOnText()
              end,
              setFunc = function(value)
                FurC.SetFilterAllOnText(value)
              end,
            },
            { -- checkbox: Exclude books from these
              ...
              getFunc = function()
                return FurC.GetFilterAllOnTextNoBooks()
              end,
              setFunc = function(value)
                FurC.SetFilterAllOnTextNoBooks(value)
              end,
            ...
            { -- checkbox: Exclude crown store items from these
              ...
              getFunc = function()
                return FurC.GetFilterAllOnTextNoRumour()
              end,
              setFunc = function(value)
                FurC.SetFilterAllOnTextNoRumour(value)
              end,
              disabled = not FurC.GetFilterAllOnText(),
            },
          },
    ...
    { -- checkbox: Disable
      ...
      getFunc = function()
        return (not FurC.GetDisableTooltips())
      end,
      setFunc = function(value)
        FurC.SetDisableTooltips(not value)
      end,
    },
    { -- checkbox: Colorize tooltips for clarity?
      ...
      getFunc = function()
        return FurC.GetColouredTooltips()
      end,
      setFunc = function(value)
    ...
    { -- checkbox: Hide 'known by' from tooltip
      ...
      disabled = FurC.GetDisableTooltips(),
      getFunc = function()
        return (FurC.GetHideKnowledge())
      end,
      setFunc = function(value)
        FurC.SetHideKnowledge(value)
      end,
    },
    { -- checkbox: Hide 'known by' from tooltip
      type = "checkbox",
      ...
      disabled = FurC.GetDisableTooltips(),
      getFunc = function()
        return (FurC.GetHideUnknown())
      end,
      setFunc = function(value)
        FurC.SetHideUnknown(value)
      end,
    },
    ...
    { -- checkbox: Hide item source
      ...
      disabled = FurC.GetDisableTooltips(),
      getFunc = function()
        return (FurC.GetHideCraftingStation())
      end,
      setFunc = function(value)
        FurC.SetHideCraftingStation(value)
      end,
    },
    { -- checkbox: Hide materials from tooltip
      ...
      disabled = FurC.GetDisableTooltips(),
      getFunc = function()
        return (FurC.GetHideMats())
      end,
      setFunc = function(value)
        FurC.SetHideMats(value)
      end,
    },
  } -- optionsData end
