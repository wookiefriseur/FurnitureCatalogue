local strings = {
  ...
  SI_FURC_STRING_MENU_ADD_ICONS_INV_NAME = "Ajouter des éléments à des recettes connues/inconnues?",
  SI_FURC_STRING_MENU_ADD_ICONS_INV_TT = "Vous ne devriez remarquer aucun retard",
